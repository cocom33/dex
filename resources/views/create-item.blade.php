        ...
        <div class="container-fluid py-4">
            <div class="card">
                ...
                <div class="card-body pt-4 p-3">
                    <form action="{{ Route('store-item') }}" method="POST" role="form text-left"
                            ...
                            <div class="col">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-auto">
                                        ...
                                        <div class="@error('id_wp') border border-danger rounded-3 @enderror">
                                            <input type="number" class="form-control" id="id_wp" name="id_wp"
                                                value="{{ old('id_wp') }}">
                                            @error('id_wp')
                                                <p class="text-danger text-xs ms-2 mt-2">{{ $message }}</p>
                                            @enderror
                        ...
                        <div class="row mt-3">
                            <div class="col-md-3 mt-3 mt-md-0">
                                ...
                                <select class="form-select" name="refine" id="refine">
                            ...
                            <div class="col-md-3 mt-3 mt-md-0">
                                ...
                                <select class="form-select" name="weapon_element" id="weapon_element">
                                    <option value="" class="d-none">Choose</option>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-3 mt-3 mt-md-0">
                                ...
                                <select class="form-select" name="awaken" id="awaken">
                            ...
                            <div class="col-md-3 mt-3 mt-md-0">
                                ...
                                <select class="form-select" name="dismantle" id="dismantle">
                            ...
                            <div class="col-6 row m-0">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <div class="@error('skill_1') border border-danger rounded-3 @enderror">
                                            <input type="text" name="skill_1" id="skill_1" class="form-control"
                                                value="{{ old('skill_1') }}">
                                            @error('skill_1')
                                                <p class="text-danger text-xs ms-2 mt-2">{{ $message }}</p>
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="@error('skill_1_desc') border border-danger rounded-3 @enderror">
                                            <textarea name="skill_1_desc" placeholder="Skill 1 Description" class="form-control">{{ old('skill_1_desc') }}</textarea>
                                            @error('skill_1_desc')
                                                <p class="text-danger text-xs ms-2 mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-6 row m-0">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <div class="@error('skill_2') border border-danger rounded-3 @enderror">
                                            <input type="text" name="skill_2" id="skill_2" class="form-control"
                                                value="{{ old('skill_2') }}">
                                            @error('skill_2')
                                                <p class="text-danger text-xs ms-2 mt-2">{{ $message }}</p>
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="@error('skill_2_desc') border border-danger rounded-3 @enderror">
                                            <textarea name="skill_2_desc" placeholder="skill 2 Description" class="form-control">{{ old('skill_2_desc') }}</textarea>
                                            @error('skill_2_desc')
                                                <p class="text-danger text-xs ms-2 mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
...
<script>
    ...
    // let wp_type = document.getElementById('#weapon_type').value;
    // let wp_ele = document.getElementById('#type').value;

    console.log(type);

    if (type === "weapon") {
        document.getElementById('#weapon_type').value = wp_type;
        document.getElementById('#weapon_element').value = wp_ele;
    }
    // else {
    //     document.getElementById('#weapon_type').value;
    //     document.getElementById('#weapon_element').value;
    // }
</script>
